package com.musiktok.musictok.ActivitesFragment.Profile;
...
import com.musiktok.musictok.ActivitesFragment.Following_F;
import com.musiktok.musictok.ActivitesFragment.See_Full_Image_F;
import com.musiktok.musictok.ApiClasses.ApiLinks;
import com.musiktok.musictok.ApiClasses.ApiRequest;
import com.musiktok.musictok.Interfaces.API_CallBack;
...
import com.musiktok.musictok.ActivitesFragment.Following_F;
import com.musiktok.musictok.Main_Menu.RelateToFragment_OnBack.RootFragment;
import com.musiktok.musictok.ActivitesFragment.Profile.Liked_Videos.Liked_Video_F;
import com.musiktok.musictok.ActivitesFragment.Profile.UserVideos.UserVideo_F;
import com.musiktok.musictok.Models.PrivacyPolicySettingModel;
import com.musiktok.musictok.Models.PushNotificationSettingModel;
            ...
            if (code.equals("200")) {
                ...
                if (!User.optString("id").
                    ...
                    if (follow_status.equalsIgnoreCase("following")) {
                        ...
                        follow_unfollow_btn.setBackground(getActivity().getResources().getDrawable(R.drawable.d_bottom_black_line));;
                        ...
                        Log.w("msg","follow 3");
                        follow_unfollow_btn.setBackground(getActivity().getResources().getDrawable(R.drawable.login_btn_draw));
                        follow_unfollow_btn.setTextColor(Color.parseColor("#ffffff"));
